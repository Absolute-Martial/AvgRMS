# IncidentFox Local CLI

> **Note:** This is in early development. For a more stable experience, consider the [Claude Code Plugin](../claude_code_pack/README.md).

Self-hosted multi-agent AI SRE with full customization control.
...
python -m incidentfox_cli --local-investigate "Check unusual access"  # Run SentinentialFox locally
```
